...
export default function Hero() {
    return (
        <section className="flex flex-col items-center pt-16 md:pt-24 relative max-h-fit container px-4 md:px-0">
            ...
            <Image src="/assets/app.png" alt="dashboard-img" className="pointer-events-none mt-6 md:-mt-10 -mb-20 md:-mb-42 [mask-image:linear-gradient(to_bottom,black_20%,transparent_70%)]" width="1120" height="815" draggable={false} loading="lazy" />
        </section>
    );
}