...
export default function Hero() {
    return (
        <section className="flex flex-col items-center pt-24 relative max-h-fit container">
            <div className="flex flex-col gap-4 items-center">
                ...
                <h1 className="text-5xl md:text-7xl font-bold tracking-tighter bg-gradient-to-b from-white to-[#B372CF] text-transparent bg-clip-text  text-center leading-[1.1]">
                    Boost your <br /> rankings with AI.
                </h1>
                <p className="text-white max-w-md text-center">Elevate your site’s visibility effortlessly with AI, where smart technology meets user-friendly SEO tools.</p>
